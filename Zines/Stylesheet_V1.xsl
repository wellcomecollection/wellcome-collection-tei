                        ...
                        <msDesc>
                            ...
                            <msContents>
                                ...
                                <msItem n="" xml:id="">
                                    ...
                                    <author key=""><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[4]/marc:subfield[1]"/></author>
                                    <title key=""><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[5]/marc:subfield[1]"/></title>
                            ...
                            <physDesc>
                                ...
                                <objectDesc form="">
                                    ...
                                    <supportDesc material="">
                                        ...
                                        <extent><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[7]/marc:subfield[1]"/>
                                            <dimensions unit="" type=""><!-- Add if available -->
                                                <dim type="diameter"><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[7]/marc:subfield[3]"/></dim>
                                                <dim type="length"></dim>
                                    ...
                                    <layoutDesc>
                                        ...
                                        <layout writtenLines="">
                                            <xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[7]/marc:subfield[2]"/>                                       
                                        </layout>
                            ...
                            <history>
                                <origin>
                                    <origPlace>
                                        ...
                                        <region><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[6]/marc:subfield[1]"/></region>,
                                        <settlement><!-- insert --></settlement>,
                                        <orgName><!-- insert --></orgName>
                                    </origPlace>
                                    <origDate calendar=""><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[4]/marc:subfield[2]"/></origDate>
                                ...
                                <acquisition><xsl:value-of xmlns:marc="http://www.loc.gov/MARC21/slim" select="/marc:collection/marc:record[1]/marc:record[1]/marc:datafield[6]/marc:subfield[2]"/></acquisition>
                            </history>
